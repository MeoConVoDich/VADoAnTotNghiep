...
namespace DoAnTotNghiep.Config
{
    public static class ObjectExtentions
    {
        ...
        public static DateTime? ConvertCultureVN(this string input)
        {
            CultureInfo culture1 = CultureInfo.CreateSpecificCulture("vi-VN");
            DateTime dateTime;
            string[] font = { "dd/MM/yyyy", "dd/MM/yyyy HH:mm:ss", "dd-MM-yyyy", "dd-MM-yyyy HH:mm:ss", "d/M/yyyy", "d/M/yyyy HH:mm:ss", "d-M-yyyy" };
        ...
        public static string ToFormatedNumber<T>(this T d_value, string format = "0.##0,#")
        {
            if (d_value.IsNullOrEmpty())
            {
                return "0";
        ...
        public static string ToDecimalUnFormat(this decimal d_value)
        {
            ...
            string value = d_value.ToString("N");
            if (value.Contains(","))
            {
        ...
        public static string ToDecimalUnFormat(this decimal d_value, IFormatProvider provider = null)
        {
            if (d_value.IsNullOrEmpty())
            {
                return string.Empty;
            }
            string value = provider != null ? d_value.ToString(provider) : d_value.ToString();
            if (value.Contains(","))
            {
                return value.TrimEnd('0').TrimEnd(',');
            }
