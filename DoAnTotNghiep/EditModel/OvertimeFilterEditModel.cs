...
{
    public class OvertimeFilterEditModel : EditBaseModel
    {
        ...
        public Property<OvertimeFilterEditModel> Property { get; set; } = new Property<OvertimeFilterEditModel>();

        public OvertimeFilterEditModel()
        {
