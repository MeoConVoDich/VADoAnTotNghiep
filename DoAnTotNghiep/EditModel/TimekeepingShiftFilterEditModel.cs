...
{
    public class TimekeepingShiftFilterEditModel : EditBaseModel
    {
        public Page Page { get; set; } = new Page();
        public string CodeOrName { get; set; }
        public virtual string EffectiveState { get; set; } = Config.EffectiveState.All.ToString();

        public Property<TimekeepingShiftFilterEditModel> Property { get; set; } = new Property<TimekeepingShiftFilterEditModel>();

        public TimekeepingShiftFilterEditModel()
        {
