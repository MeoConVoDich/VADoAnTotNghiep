...
{
    public class FingerprintManagementFilterEditModel : EditBaseModel
    {
        ...
        public Property<FingerprintManagementFilterEditModel> Property { get; set; }
        public FingerprintManagementFilterEditModel()
        {
            Property = new Property<FingerprintManagementFilterEditModel>();
