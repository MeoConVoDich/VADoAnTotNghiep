...
namespace DoAnTotNghiep.ViewModel
{
    public class WorkShiftTableViewModel
    {
        ...
        public virtual string UsersId { get => Users?.Id; set { } }
        ...
        public virtual UsersViewModel Users { get; set; } = new UsersViewModel();

        public virtual string Day01 { get; set; }
        public virtual string Day02 { get; set; }
        public virtual string Day03 { get; set; }
        public virtual string Day04 { get; set; }
        public virtual string Day05 { get; set; }
        public virtual string Day06 { get; set; }
        public virtual string Day07 { get; set; }
        public virtual string Day08 { get; set; }
        public virtual string Day09 { get; set; }
